# Gareth Sheldon - Cybersecurity Portfolio
...
**Overview:** Developed a Python tool using dnspython and tkinter to check SPF, DMARC, and DKIM DNS records via a user-friendly GUI.
